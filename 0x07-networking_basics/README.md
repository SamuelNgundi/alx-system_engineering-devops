...
[1-types_of_network](./1-types_of_network) | What type of network are Room iMacs connected to? What type of network could connect an office in one building to another office in a building a few streets away? What network do you use when you browse www.youtube.com from your smartphone (not connected to the Wifi)?
